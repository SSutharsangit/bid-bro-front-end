...
const AuctionModal = ({ setShowModal, productName }) => {
    ...
    const handleButtonClick = () => {
        ...
        const data = {
            productName, // Dynamically use the product name
            ...
            <div className="bg-white w-full max-w-4xl mx-auto p-8 rounded-3xl shadow-xl">
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    <div className="flex flex-col w-full md:w-1/3 gap-8 align-items-center">
                        <div className="text-3xl font-bold">{productName}</div> {/* Dynamic Product Name */}
